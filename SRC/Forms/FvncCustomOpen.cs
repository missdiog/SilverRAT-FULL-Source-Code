...
public class FvncCustomOpen : Form
{
    ...
    public FvncCustomOpen(Clients Socket, string Info)
    {
        InitializeComponent();
    ...
    private void Run_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                MessageBox.Show(this, "Please enter the path of the executable file", "Hidden VNC | Custom Open!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        {
            MessageBox.Show(this, ex.Message, "Hidden VNC | Custom Open!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }
    }
    ...
    private void FvncCustomOpen_Shown(object sender, EventArgs e)
    {
        Program.Silver.TransitionShowng.ShowSync(panelForm);
    }

    private void FvncCustomOpen_FormClosing(object sender, FormClosingEventArgs e)
    {
        Program.Silver.TransitionHiddeng.HideSync(panelForm);
    }
    ...
    private void InitializeComponent()
    {
        ...
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Forms.FvncCustomOpen));
        ...
        this.TitlrPage.Size = new System.Drawing.Size(74, 15);
        this.TitlrPage.TabIndex = 608;
        this.TitlrPage.Text = "- Hidden VNC";
        ...
        base.Name = "FvncCustomOpen";
        base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
        this.Text = "FvncCustomOpen";
        base.TransparencyKey = System.Drawing.Color.Gainsboro;
        base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(FvncCustomOpen_FormClosing);
        base.Shown += new System.EventHandler(FvncCustomOpen_Shown);
